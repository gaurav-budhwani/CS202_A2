...
# tools installation
echo "Installing Bandit and Semgrep..."
pip install pandas bandit semgrep flake8 dlint flake8-json &> /dev/null
echo "Bandit and Semgrep installed."

# clone repo
echo "Cloning large-scale open-source projects..."
...
echo "Repositories cloned successfully into the 'projects/' directory."
